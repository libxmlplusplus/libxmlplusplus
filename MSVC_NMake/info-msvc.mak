...
help:
	...
	@echo.
	@echo USE_COMPAT_LIBS: Use this if your libsigc++ and glibmm was built with Visual Studio
	@echo 2017 or 2019 but has the "vc150" in its .lib filename.  This also makes the DLL and
	@echo .lib filesnames for libxml++ contain "vc150" as well.
	@echo.
	...
	@echo $$(BASE_INCLUDEDIR)\\include. [DEP] includes LIBXML2, GLIBMM, SIGC, GLIB;
	@echo the 'libxml2/glibmm-2.68/sigc++-3.0/glib-2.0'
	@echo subdirectories of $$([DEP]_INCLUDEDIR) will be looked for automatically
	@echo.
	@echo [DEP]_INCLUDEDIR: Directory to look for .lib's for [DEP], default is in
	@echo $$(BASE_INCLUDEDIR)\\lib, as well as their architecture-dependent headers,
	@echo if applicable, where their corresponding subdirs like the ones mentioned in
	@echo [DEP]_INCLUDEDIR will be looked for automatically. [DEP] includes LIBXML2,
	@echo GLIBMM, SIGC, GLIB.
	@echo.
	@echo ======
